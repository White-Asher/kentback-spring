---
name: commit-tdd
description: Commit TDD work with strict checks for passing tests and separation of structural vs behavioral changes. Use when the user asks to make a TDD commit.
---
